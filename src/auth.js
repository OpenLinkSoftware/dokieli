...
function showUserIdentityInput (e) {
  ...
  window.setTimeout(function () {
    ...
    var code = '<aside id="user-identity-input" class="do on">' + Config.Button.Close + '<h2>WebID-TLS Authentication</h2><p id="user-identity-input-webid"><label>WebID</label> <input id="webid" type="text" placeholder="http://csarven.ca/#i" value="'+webid+'" name="webid"/> <button class="signin">Login</button></p>';
    if (window.location.protocol === "https:") {
      code += '<p id="user-identity-input-oidc"><h2>WebID-OIDC Authentication</h2> <button class="signin-oidc">Select Identity Provider</button></p>';
    }
    code += ' </aside>';
